...
public final class AdminBinding implements ViewBinding {
  ...
  private AdminBinding(@NonNull CoordinatorLayout rootView, @NonNull BottomNavigationView bottomnav,
  ...
  public static AdminBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new AdminBinding((CoordinatorLayout) rootView, bottomnav, frameLayout, main);
    }
